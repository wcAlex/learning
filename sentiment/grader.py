...
grader.addBasicPart('3e-0-basic', test3e0, maxSeconds=60*60, description="test basic character n-gram features")
...
def test3f2():
    ...
    grader.requireIsLessThan(0.04, trainError)
    grader.requireIsLessThan(0.30, devError)
grader.addBasicPart('3f-0-basic', test3f2, maxPoints=2, maxSeconds=60, description="test classifier on real polarity dev dataset")
