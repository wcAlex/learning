...
grader.addBasicPart('0c-1-basic', test0c, 1, maxSeconds=60*60, description="Basic test for create_chain_csp")
...
grader.addBasicPart('1c-1-basic', test1c_1, 1, maxSeconds=60*60, description="Basic test for AC-3 with n-queens CSP")
...
grader.addBasicPart('3a-1-basic', test3a_1, 2, maxSeconds=60*60, description="Basic test for add_quarter_constraints")
