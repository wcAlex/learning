...
def add_parts_2(grader, submission):
    ...
    grader.addBasicPart('2b-1-basic', t_2b_1, maxPoints=1, maxSeconds=60*60, description='simple test case')
...
def add_parts_3(grader, submission):
    ...
    grader.addBasicPart('3b-1-basic', t_3b_1, maxPoints=1, maxSeconds=60*60, description='simple test case with hand-picked bigram costs and possible fills')
